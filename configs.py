...
# 修改 configs.py
_C.DRUG.MOLT5_DIM = 768   # molt5-base 的维度
_C.DRUG.MACCS_DIM = 167   # MACCS 指纹通常为167位（包括第0位占位符）
_C.DRUG.FRAG_NODE_DIM = 167   # BRICS 片段图节点使用片段 MACCS 指纹
_C.DRUG.NODE_IN_EMBEDDING = 128 # 最终映射到 BANLayer 的维度
...
_C.PROTEIN_LA = CN()
_C.PROTEIN_LA.conv_embeddings_dim = 1044
